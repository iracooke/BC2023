...
You can also use the `~` as part of a path relative to your home directory. For example you could list the contents of your `learning_unix` directory as follows:

```bash
learner@:/$ ls ~/learning_unix
```
